...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'api_key' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'api_key_plain' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'username' => ['type' => 'index', 'columns' => ['username', 'email', 'token'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'token_expires' => '2019-04-19 00:55:47',
                'is_superuser' => 1,
                'role' => 'Lorem ipsum dolor sit amet',
                'active' => 1,
                'created' => '2019-04-19 00:55:47',
                'modified' => '2019-04-19 00:55:47',
                'deleted' => '2019-04-19 00:55:47',
                'created_by' => 1,
                'modified_by' => 1
            ],
        ];
